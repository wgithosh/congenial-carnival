...
const products = [
  {
    ...
    price: 89.99,
    image: "https://images.unsplash.com/photo-1755589614356-bf6d276f5ca5?auto=format&fit=crop&w=800&q=80",
    stock: 50,
  ...
  },
  {
    ...
    price: 129.99,
    image: "https://images.unsplash.com/photo-1747397454085-d6acb0502daf?auto=format&fit=crop&w=800&q=80",
    stock: 35,
    category: "Headsets",
  },
  {
    ...
    price: 149.99,
    image: "https://images.unsplash.com/photo-1713526211434-0b4c6c9adaa7?auto=format&fit=crop&w=800&q=80",
    stock: 40,
    category: "Keyboards",
  },
  {
    ...
    price: 79.99,
    image: "https://images.unsplash.com/photo-1660491083562-d91a64d6ea9c?auto=format&fit=crop&w=800&q=80",
    stock: 60,
    category: "Mice",
  },
  {
    ...
    price: 349.99,
    image: "https://images.unsplash.com/photo-1666771410003-8437c4781d49?auto=format&fit=crop&w=800&q=80",
    stock: 25,
    category: "Monitors",
  },
  {
    ...
    price: 249.99,
    image: "https://images.unsplash.com/photo-1633545486613-feaf749f7805?auto=format&fit=crop&w=800&q=80",
    stock: 15,
    category: "Chairs",
  },
];
...
const seedProducts = async () => {
  try {
    ...
    products.forEach(p => console.log(`Inserted: ${p.title} (Category: ${p.category}, Stock: ${p.stock})`));
