...
export default function Hero() {
  ...
  return (
    ...
    >
      {/* --- PRELOADED LQIP Blur Placeholder (non-LCP) --- */}
      <img
      ...
      {/* --- MAIN HERO IMAGE (LCP — DO NOT LAZY LOAD) --- */}
      <motion.img
        ...
        height="900"
        decoding="async"
        fetchpriority="high"  // 🚀 MAKES THIS LCP, FIXES MOBILE SCORE
      ...
      >
        ...
        <p className="text-sm sm:text-base md:text-lg text-gray-300 mb-6">
          Discover high-performance gaming gear engineered to power your
          passion and elevate every victory.
        </p>
