...
const TestimonialCard = memo(({ testimonial, prefersReducedMotion }) => (
  <motion.div
    ...
    dragElastic={0.18}
    className="bg-white/10 dark:bg-white/5 border border-gray-200/10 backdrop-blur-xl rounded-3xl p-8 sm:p-10 shadow-xl max-w-md sm:max-w-2xl mx-auto"
  >
    <img
...
export default function Testimonials() {
  ...
  return (
    <section
      ...
      className="py-24 bg-gradient-to-b from-gray-50 to-white dark:from-[#0f0f0f] dark:to-[#050505] overflow-hidden relative"
    >
      <div className="max-w-5xl mx-auto px-6 lg:px-8 text-center">
        ...
        <div className="relative flex justify-center items-center">
          ...
          <button
            ...
            className="absolute left-2 sm:left-0 top-1/2 -translate-y-1/2 p-2 rounded-full bg-white/20 dark:bg-black/30 hover:bg-primary/40 focus:ring-2 focus:ring-primary transition"
          >
          ...
          <button
            ...
            className="absolute right-2 sm:right-0 top-1/2 -translate-y-1/2 p-2 rounded-full bg-white/20 dark:bg-black/30 hover:bg-accent/40 focus:ring-2 focus:ring-accent transition"
          >
