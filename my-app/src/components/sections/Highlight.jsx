      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-16 flex flex-col-reverse lg:flex-row items-center gap-16">
        ...
        >
          <div className="relative">
             <img
  src="https://plus.unsplash.com/premium_photo-1682141878168-5dace8e1785d?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8Z2FtaW5nJTIwJTIwZGVza3N8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=1000&q=80"
