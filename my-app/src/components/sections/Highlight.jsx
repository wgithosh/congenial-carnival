...
function About() {
  ...
  const yBackground = useTransform(scrollY, [0, 500], [0, 50]); // moves 50px as you scroll
  ...
  return (
    ...
    >
      ...
      <motion.img
        style={{ y: prefersReducedMotion ? 0 : yBackground }}
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
            <motion.a
              ...
              href="#contact"
              className="bg-primary text-white px-6 py-2 sm:px-8 sm:py-3 rounded-full shadow-md hover:bg-primary/80 transition font-semibold focus:outline-none focus-visible:ring-2 focus-visible:ring-primary"
            >
              Join the Squad
            </motion.a>
            ...
            <motion.a
              ...
              whileTap={prefersReducedMotion ? {} : { scale: 0.97 }}
              href="#shop"
              className="border border-primary text-primary dark:text-primary px-6 py-2 sm:px-8 sm:py-3 rounded-full hover:bg-primary/10 transition font-semibold focus:outline-none focus-visible:ring-2 focus-visible:ring-primary"
            >
              Browse Gear
            </motion.a>
          </div>
